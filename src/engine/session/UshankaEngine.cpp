...
using namespace U::Engine;


UshankaEngine::UshankaEngine(std::shared_ptr<U::Engine::Platform::Platform> platform)
    : _platform(platform)
{
}
...
// Todo: split out engine specific and game specific stuff
bool UshankaEngine::run()
{
    bool success = true;
