...
inline void U::NativeRenderer::frameBegin() noexcept
{
...
inline void U::NativeRenderer::frameEnd() noexcept
{
...
inline bool U::NativeRenderer::wait() const noexcept
{
    return aptMainLoop();
}

inline Size U::NativeRenderer::getWindowSize() const noexcept
{
