...
struct Shader::ShaderImpl {
        ...
        {
            {
                ...
                glVertexAttribPointer(vertexPosAttribIndex, 3, GL_FLOAT, GL_FALSE, 2 * per_vertex * sizeof(vertex_element_t), (void*)0);
                // 3 floats for color
                glEnableVertexAttribArray(colorAttribIndex);
                glVertexAttribPointer(colorAttribIndex, 3, GL_FLOAT, GL_FALSE, 2 * per_vertex * sizeof(vertex_element_t), (void*)(per_vertex * sizeof(vertex_element_t)));
            }
    ...
    inline void pushBufferData(std::vector<vertex_element_t> bufferData)
    {
        glBufferData(GL_ARRAY_BUFFER, sizeof(vertex_element_t) * bufferData.size(), bufferData.data(), GL_STATIC_DRAW);
    }
...
{
    std::vector<vertex_element_t> vertexWithColor;
