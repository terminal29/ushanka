...
namespace U::Engine::Render::Voxel {
	...
	struct Voxel {
		glm::ivec3 position;
        U::Engine::Util::Color color;
		entt::hashed_string::hash_type shaderID;
	};

    /// <summary>
    /// Naive meshering of a list of voxels
    /// </summary>
    inline std::vector<U::Engine::Util::Constants::vertex_t> meshVoxels(const std::vector<Voxel>& voxels) {
        std::vector<U::Engine::Util::Constants::vertex_t> vertices;
